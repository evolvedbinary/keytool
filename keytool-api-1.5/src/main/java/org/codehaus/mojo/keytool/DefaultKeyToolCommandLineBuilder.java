    ...
    extends AbstractKeyToolCommandLineBuilder
{
    ...
    {
        addKeytoolCommandAndDefaultoptions( cli, "-keyclone", request );
        addArgIfNotEmpty( cli, "-dest", request.getDestalias() );
    ...
    {
        addKeytoolCommandAndDefaultoptions( cli, "-genkey", request );
...
//        addArgIfNotEmpty( cli, "-startdate", request.getStartdate() );
    ...
    {
        addKeytoolCommandAndDefaultoptions( cli, "-import", request );
